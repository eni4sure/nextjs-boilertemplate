...
export const authVerifyEmail = async (data: any) => await $http.post("/auth/verify-email", { userId: data.userId, verificationToken: data.verificationToken, verificationCode: data.verificationCode }).then((res) => res.data);
